...
import { useNotifications } from '../../../src/hooks/admin/useNotifications.jsx'
import { notificationService } from '../../../src/services/admin/notificationService.js'

// Mock del servicio
vi.mock('../../../src/services/admin/notificationService.js', () => ({
  notificationService: {
