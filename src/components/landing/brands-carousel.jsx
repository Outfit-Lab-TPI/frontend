...
export default function BrandsCarousel() {
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="!text-3xl md:!text-4xl font-bold text-center mb-12 text-[var(--white)]">
            Marcas que <span className="text-[var(--tertiary)]">confían</span>{" "}
            en nosotros
          </h2>
  ...
  return (
    <section id="marcas" className="py-16 px-20 mb-20">
      <div className="max-w-[1330px] mx-auto">
        <h2 className="!text-3xl md:!text-4xl font-bold text-center mb-12 text-[var(--white)]">
          Marcas que <span className="text-[var(--tertiary)]">confían</span> en
          nosotros
        </h2>
        {error && (
              ...
              >
                ...
                >
                  <div
                    ...
                    style={{
                      background:
                        "radial-gradient(circle, rgba(143, 93, 141, 0.3) 0%, rgba(35, 6, 54, 0.2) 50%, transparent 70%)",
                      zIndex: -1,
                    }}
                  />
                  <img
          ...
          {brands.map((brand) => (
            ...
            >
              <div
                ...
                style={{
                  background:
                    "radial-gradient(circle, rgba(143, 93, 141, 0.4) 0%, transparent 70%)",
                  zIndex: -1,
                }}
              />
              <img
