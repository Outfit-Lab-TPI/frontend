export default function CallToAction({
  ...
  return (
    <div className={`text-${align}`}>
      <a
        href={url}
        className="relative inline-block font-semibold px-6 py-3 rounded-2xl hover:!text-[var(--primary)] overflow-hidden transition-all duration-300 ease-in-out hover:scale-105 group"
      >
