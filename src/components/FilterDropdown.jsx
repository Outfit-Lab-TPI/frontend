...
function FilterDropdown({
  ...
  const hayFiltrosActivos = filtros.marca || filtros.color || filtros.soloFavoritas;
  const contadorFiltros = [filtros.marca, filtros.color, filtros.soloFavoritas].filter(Boolean).length;
        ...
        <div className="absolute top-full left-0 mt-2 w-80 bg-black border border-gray/20 rounded-lg shadow-xl z-50">
          <div className="p-4">
            ...
            <div className="flex items-center justify-between mb-4">
              <span className="text-sm font-medium text-white">Filtrar prendas</span>
              {hayFiltrosActivos && (
                <Button
                  onClick={() => {
                    onLimpiarFiltros();
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <select
                  value={filtros.marca}
                  onChange={(e) => onActualizarFiltros({ marca: e.target.value })}
              ...
              <div>
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    ...
                    onChange={(e) => onActualizarFiltros({ soloFavoritas: e.target.checked })}
                    className="sr-only"
                  />
