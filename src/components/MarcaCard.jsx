...
function MarcaCard({ marca }) {
  ...
  return (
    <div
      className="relative w-full h-80 bg-gray rounded-lg overflow-hidden cursor-pointer transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-black/30 group"
      onClick={handleClick}
    >
